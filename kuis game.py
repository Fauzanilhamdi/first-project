...
pernyataan = input("apa kepanjangan dari DVD? ")
if pernyataan == "digital versaitle disc" :
    print("BENAR")
    score += 1
else:
    print("SALAH")

pernyataan = input("apa kepanjangan dari VCD? ")
if pernyataan == "video compact disc":
    print("Benar")
    score += 1
else:
    print("SALAH")
    
pernyataan = input("apa kepanjangan dari LED? ")
if pernyataan == "light emitting diode":
    print("BENAR")
    score += 1
else:
    print("SALAH")
...
print("anda mempunyai nilai " + str(score/10 * 100)+"%.")